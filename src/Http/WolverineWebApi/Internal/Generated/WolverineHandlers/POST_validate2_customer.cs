...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class POST_validate2_customer : Wolverine.Http.HttpHandler
    {
        ...
        public POST_validate2_customer(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, Wolverine.Http.FluentValidation.IProblemDetailSource<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateCustomer2> problemDetailSource) : base(wolverineHttpOptions)
        {
        ...
        {
            var createCustomerValidator = new Wolverine.Http.Tests.DifferentAssembly.Validation.CreateCustomer2.CreateCustomerValidator();
            ...
            var result1 = await Wolverine.Http.FluentValidation.Internals.FluentValidationHttpExecutor.ExecuteOne<Wolverine.Http.Tests.DifferentAssembly.Validation.CreateCustomer2>(createCustomerValidator, _problemDetailSource, customer).ConfigureAwait(false);
