...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public class POST_validate_customer : Wolverine.Http.HttpHandler
    {
        ...
        public POST_validate_customer(Wolverine.Http.WolverineHttpOptions wolverineHttpOptions, Wolverine.Http.FluentValidation.IProblemDetailSource<WolverineWebApi.Validation.CreateCustomer> problemDetailSource) : base(wolverineHttpOptions)
        {
        ...
        {
            var createCustomerValidator = new WolverineWebApi.Validation.CreateCustomer.CreateCustomerValidator();
            ...
            var result1 = await Wolverine.Http.FluentValidation.Internals.FluentValidationHttpExecutor.ExecuteOne<WolverineWebApi.Validation.CreateCustomer>(createCustomerValidator, _problemDetailSource, customer).ConfigureAwait(false);
